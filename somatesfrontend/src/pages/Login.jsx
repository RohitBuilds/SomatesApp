...
function Login({ onLoginSuccess }) {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // This updates the "unauth" → "auth" status so Protected route
      // lets us in instead of bouncing back to /login
  ...
  return (
    <div className="relative w-screen h-screen bg-[#eef2f6] overflow-hidden flex items-center justify-center">
      ...
      {/* Decorative circles */}
      <div className="absolute w-[600px] sm:w-[1000px] h-[600px] sm:h-[1000px] border border-blue-700 rounded-full opacity-30 -top-64 sm:-top-96 -left-40 sm:-left-64" />
      <div className="absolute w-[500px] sm:w-[800px] h-[500px] sm:h-[800px] border border-blue-500 rounded-full opacity-30 -bottom-64 sm:-bottom-96 -right-32 sm:-right-48" />
      <div className="absolute w-[400px] sm:w-[600px] h-[400px] sm:h-[600px] border border-blue-500 rounded-full opacity-30 top-20 sm:top-40 right-10 sm:right-20" />
